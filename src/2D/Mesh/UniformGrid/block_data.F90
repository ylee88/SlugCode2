...
#include "definition.h"
  ...
  integer, save :: bl_iProcs, bl_jProcs  ! # of procs in each direction
  integer, save :: bl_nProcs             ! total # of procs
  integer, save :: bl_ID                 ! processor ID
  integer, save :: bl_i, bl_j            ! block coordinate for a processor
  ...
  integer, allocatable, dimension(:), save :: bl_BC, bl_cornerBC
