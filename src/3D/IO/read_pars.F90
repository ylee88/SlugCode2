...
#include "definition.h"
  ...
  call read_initFileChar(filename,'sim_bcTypeZ', sim_bcTypeZ)
  ...
  call read_initFileInt (filename,'gr_nz',   gr_nz)
  ...
  call read_initFileReal(filename,'gr_zbeg', gr_xbeg(ZDIM))
  call read_initFileReal(filename,'gr_zend', gr_xend(ZDIM))

  !read block data
  call read_initFileInt (filename,'bl_iProcs',   bl_iProcs)
  call read_initFileInt (filename,'bl_jProcs',   bl_jProcs)
  call read_initFileInt (filename,'bl_kProcs',   bl_kProcs)
